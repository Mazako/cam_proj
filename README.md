...
On the first run, the application creates the SQLite database at `database_path` and seeds it with the cameras from TOML. On subsequent runs, SQLite is the source of truth for cameras, events, and uploads.
