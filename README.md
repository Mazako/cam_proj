...
Wartości wrażliwe w TOML-u są zapisane jako ciphertexty AES-256-GCM zakodowane Base64. Klucz odszyfrowujący musi być dostarczony osobno przez `CAMWATCH_CONFIG_KEY`. Nie zapisuj klucza w repozytorium.

Do zaszyfrowania wartości ze standardowego wejścia użyj:
